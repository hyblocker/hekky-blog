...
[**🖥️ Demo Langsung (Vercel)**](https://hekky.dev)
...
- Admonisi ([Pratinjau & Cara Pakai](https://hekky.dev/posts/markdown-extended/#admonitions))
- Kartu repositori GitHub ([Pratinjau & Cara Pakai](https://hekky.dev/posts/markdown-extended/#github-repository-cards))
- Kode blok ekspresif lewat Expressive Code ([Pratinjau](https://hekky.dev/posts/expressive-code/) / [Dokumentasi](https://expressive-code.com/))
